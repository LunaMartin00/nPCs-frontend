    ...
    <Navbar dark expand="md" className="custom-navbar" {...args}>
      ...
      <Collapse isOpen={isOpen} navbar>
        <Nav className="me-auto align-items-center" navbar>
          ...
          <NavItem>
            <NavLink tag={Link} to="/tienda/armar-pc" className="nav-link-custom">
          ...
          <UncontrolledDropdown nav inNavbar>
            ...
            <DropdownMenu>
              <DropdownItem tag={Link} to="/tienda/explorar/procesadores">Procesadores</DropdownItem>
              <DropdownItem tag={Link} to="/tienda/explorar/placas-madre">Motherboards</DropdownItem>
              <DropdownItem tag={Link} to="/tienda/explorar/tarjetas-graficas">Tarjetas de video</DropdownItem>
              ...
              <DropdownItem tag={Link} to="/tienda/explorar/gabinetes">Gabinetes</DropdownItem>
              <DropdownItem divider />
              <DropdownItem tag={Link} to="/tienda/explorar/todos">Ver Todos</DropdownItem>
            </DropdownMenu>
          </UncontrolledDropdown>

          <NavItem>
            <NavLink tag={Link} to="/tienda/builds" className="nav-link-custom">
